...
public class DeliveryView3 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DeliveryView3 window = new DeliveryView3();
	...
	private void initialize() {
		...
		JPanel panel_Delivery = new JPanel();
		frame.getContentPane().add(panel_Delivery, BorderLayout.CENTER);
		panel_Delivery.setLayout(new BorderLayout(0, 0));
		
		JPanel topPanel = new JPanel();
		topPanel.setPreferredSize(new Dimension(0, 80));
		topPanel.setBackground(MainFrame.offColor);
		panel_Delivery.add(topPanel, BorderLayout.NORTH);
		...
		panel_Delivery.add(bottomPanel, BorderLayout.SOUTH);
		
		JPanel centerPanel = new JPanel();
		centerPanel.setBackground(Color.WHITE);
		centerPanel.setPreferredSize(new Dimension(500, 0));
		panel_Delivery.add(centerPanel, BorderLayout.CENTER);
