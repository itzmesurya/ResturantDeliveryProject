...
// 		this.panel = orderPanel;
		...
		case Read:
			...
			if (OrderPanel.getSelectR_comboBox().getItemCount() > 0) {
				loadRestaurantOrders(
						Database.getRestaurantByName((String) OrderPanel.getSelectR_comboBox().getSelectedItem()));
			} else {
		...
		case Accept:
			...
			OrderPanel.getLblNewLabel_2().setVisible(false);
...
// 		oldModel.setRowCount(0);
		DefaultTableModel model = new DefaultTableModel(new Object[][] {},
				new String[] { "Meal in Order", "Quantity" });
...
// 		OrderPanel.getTable_1().setModel(oldModel_1);
		...
		DefaultTableModel model_1 = new DefaultTableModel(new Object[][] {},
				new String[] { "Order Id", "Client Name" });
